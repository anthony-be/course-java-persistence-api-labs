...
public interface ProductDao {
    ...
    Collection<Product> findAllWithApi();

    Collection<Product> findByCriteriaWithApi( String categoryName, String name, String description, BigDecimal priceFrom, BigDecimal priceTo, boolean inStock,  Date createdFrom, Date createdTo);
}
