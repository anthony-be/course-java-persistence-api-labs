...
@SequenceGenerator(name = "Inventory.sequence", sequenceName = "PRODUCT_INVENTORY_SEQ", allocationSize = 1)
@Cacheable
public class Inventory {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "Inventory.sequence")
    private Integer id;
