...
public class CustomerDaoIT extends SpringDaoContextTest {
    ...
    public void findAllWithApi() {
        Collection<Customer> actuals = dao.findAllWithApi();
        assertNotNull(actuals);
        assertFalse(actuals.isEmpty());
    }

    @Test
    public void findAllWithApiWithPaging() {
        int page = 1; //Second page
        int pageSize = 2; // 2 elements by page
        Collection<Customer> actuals = dao.findAllWithApi(page, pageSize);
        assertNotNull(actuals);
        assertEquals(2, actuals.size());
        Iterator<Customer> it = actuals.iterator();
        assertEquals("Musk", it.next().getLastname());
    ...
    @Test
    public void findByUsernameWithApi() {
        Customer actual = dao.findByUsernameWithApi("Anthony");
        assertNotNull(actual);
        assertEquals(Integer.valueOf(1), actual.getId());
    }

    @Test
    public void findByCriteriaWithApi() throws ParseException {
        // Preparation
        String username = "Anthony";
        String lastname = "feron";
        String firstname = "ThO";
        ...
        // Execution
        Collection<Customer> actuals = dao.findByCriteriaWithApi(username, lastname, firstname, birthDate, yesterday);
    ...
    @Test
    public void findByIdWithFetchGraph() throws ParseException {
        Customer actual = dao.findByIdWithFetchGraph(1);
        assertNotNull(actual);
        assertEquals("Anthony", actual.getUsername());
        assertEquals("dummy", actual.getPassword());
        assertEquals("Feron", actual.getLastname());
    ...
    @Test
    public void findByIdWithLoadGraph() throws ParseException {
        Customer actual = dao.findByIdWithFetchGraph(1);
        assertNotNull(actual);
        assertEquals("Anthony", actual.getUsername());
        assertEquals("dummy", actual.getPassword());
